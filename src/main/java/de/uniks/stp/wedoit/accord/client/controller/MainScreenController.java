...
public class MainScreenController implements Controller {
    ...
    private void addServerButtonOnClick(ActionEvent actionEvent) {
        this.editor.getStageManager().initView(POPUP_STAGE, LanguageResolver.getString("CREATE_SERVER"), "CreateServerScreen", CREATE_SERVER_SCREEN_CONTROLLER, false, null, null);
    }
    ...
    private void enterInvitationButtonOnClick(ActionEvent actionEvent) {
        this.editor.getStageManager().initView(POPUP_STAGE, LanguageResolver.getString("JOIN_SERVER"), "JoinServerScreen", JOIN_SERVER_SCREEN_CONTROLLER, false, null, null);
    }
